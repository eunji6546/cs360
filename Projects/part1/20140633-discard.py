        ...
        for item in items['Item']:
            ...
            if num_of_bid != "0":
                for bid_info in item['Bids']['Bid']:
                    #print bid_info
                    dBids.write(item_id+"|"+bid_info['Bidder']['_UserID']+"|"+transformDollar(bid_info['Time'])+"|"+transformDttm(bid_info['Time'])+"\n")
                    buyer_info = bid_info['Bidder']
                    dUser.write(buyer_info['_UserID']+"|"+buyer_info['_Rating']+"|"+makeitString(buyer_info['Location'])+"|"+makeitString(buyer_info['Country']+"\n"))
